...
interface SortSelectProps {
    updateProductFilters: (filters: { featured: string }) => void;
}

const SortSelect: React.FC<SortSelectProps> = ({ updateProductFilters }) => {
    ...
    const seleceOption = (e: React.ChangeEvent<HTMLSelectElement>) => {
