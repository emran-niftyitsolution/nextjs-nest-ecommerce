...
const SingleProductList: React.FC<SingleProductListProps> = ({ product, addToCart, addToCompare, addToWishlist, openQuickView }) => {
                ...
                <div className="product-cart-wrap">
                    <div className="product-img-action-wrap">
                        ...
                        <div className="product-badges product-badges-position product-badges-mrg">
                            ...
                            {product.totalSell && product.totalSell > 100 && <span className="best">Best Sell</span>}
