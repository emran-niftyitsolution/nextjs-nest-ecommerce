...
const MobileMenu: React.FC<MobileMenuProps> = ({ isToggled, toggleClick }) => {
                                        ...
                                        <ul className={isActive.key == 3 ? "dropdown" : "d-none"}>
                                            <li className="menu-item-has-children">
                                                ...
                                                <ul className="dropdown">
                                                    ...
                                                    <li>
                                                        <Link href="/products">Blouses & Shirts</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Hoodies & Sweatshirts</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Women's Sets</Link>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li className="menu-item-has-children">
                                                ...
                                                <ul className="dropdown">
                                                    <li>
                                                        <Link href="/products">Jackets</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Casual Faux Leather</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Genuine Leather</Link>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li className="menu-item-has-children">
                                                ...
                                                <ul className="dropdown">
                                                    <li>
                                                        <Link href="/products">Gaming Laptops</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Ultraslim Laptops</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Tablets</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Laptop Accessories</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/products">Tablet Accessories</Link>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
