                                ...
                                <div className="col-lg-9">
                                    <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                                        ...
                                        <div className="single-content mb-50">
                                            ...
                                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloribus nesciunt ut officiis quisquam incidunt laudantium voluptate, magni deleniti recusandae autem vel tempora modi minima distinctio.</p>
                                        </div>
                                    </div>
                                </div>
